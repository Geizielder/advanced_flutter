...
void main() {
    ...
    httpClient.responseJson = '''
      {
        ...
        "players": [
          ...
          },
          {
            ...
            "position": "position 2",
            "photo": "photo 2",
            "confirmationDate": "2025-10-09T11:30",
            "isConfirmed": false
          }
        ]
      }
  ...
  test('should return NextEvent on 200', () async {
    ...
    expect(event.date, DateTime(2025, 10, 10, 10, 30));
    ...
    expect(event.players[1].confirmationDate, DateTime(2025, 10, 09, 11, 30));
